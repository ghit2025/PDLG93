...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            String archivoParse = "src/ALexico/salidaVAST.txt";
         ...
         // Escribir Parse.txt
            try (BufferedWriter writer = new BufferedWriter(new FileWriter(archivoParse))) {
                writer.write(parse.trim());
            }
            ...
            System.out.println("   - Parse (fichero entrada de VAST): " + archivoParse);
